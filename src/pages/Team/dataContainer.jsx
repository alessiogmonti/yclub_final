...
export const DataContainer = (props) => {
    return (
        <Box px={1} pb={5} transformOrigin={'top center'}>
            ...
            <Container>
                <Image top={-10} src={props.profileImg? props.profileImg : yClub} boxSize={['80px','80px','80px','100px','100px']} objectFit={'cover'} borderRadius={'full'} float={['left']} mr={[3,3,3,10,10]} display={'inline-flex'} bg={'light'} position={'relative'} borderWidth={'3px'} borderColor={'accent'}  />

...
import { DataContainer } from "./Team/dataContainer"

const items = [
    {title: 'TerpHeadRick', date:'Community Manager', content:<DataContainer bio={"Have been in crypto since 2019 and first got into Discord and community building/managing for stock signals groups. Naturally as I got more into crypto I shifted into that and haven’t looked back since. "}/>},
    {title: 'The Yacht Mogul', date:'Advisor', content:<DataContainer bio={"All passion and love for yachts and their ability to inspire people all around the world. A chosen “Influencial figure in the yachting world” by some of the press such as Forbes,CNN,BOAT,Robb Report."}/>},
    {title: 'ValTron', date:'Creative Director', content:<DataContainer bio={"Creative mastermind! She is the best there is in our eyes and we love what she does. She was the screen writer for FlixPatrol that reached the TOP 10 movies on Netflix in the World in 2021 ."}/>},
    {title: 'Mega Skipper', date:'Campaign Manager', content:<DataContainer bio={"Ex VP of digital in largest Israeli advertising agency with 25 years of experience in online advertising. "}/>},
    {title: 'Polo Marco', date:'Brand Strategists & Communications', content:<DataContainer bio={"Photographer and Strategist, with over 5 years of helping brands strengthen their communications, communities, and lifestyle experiences."}/>},
    {title: 'Carrara', date:'UI/UX', content:<DataContainer bio={"Years of experience specializing in designing web & mobile apps, websites and admin portals. Believes that design is not about beautiful pixels but about solving problems & achieving business and user goals."}/>},
    {title: 'Blade', date:'Strategy', content:<DataContainer bio={"Engineered for several Fortune 500 companies in a variety of technology related roles while building his website into the top 1000 most visited websites in the world."}/>},
    ...
    {title: 'SHR', date:'Art Director (NFT)', content:<DataContainer bio={"Digital Art artist | Grafic designer | Matte Painting | CGI designer."}/>},
